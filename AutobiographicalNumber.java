...
public class AutobiographicalNumber {
	...
	public static void main(String args[]) {
		...
		//1210 autobiographical number 
		//if number equal to count of numbers then autobiographic number count 1 ==1210,next count 2 =1210,next count 1=1210 and last count 0 =1210,last 0 if yes autobiographic number
